...
class Marshaller:
    ...
    def unmarshaller(self, file):
        ...
        if res is True:
            ...
            # формируем вывод для предметов
            stringDiscipline = "\nClass Pojo [name = " + name + ", weekday = " + weekday + ", audience = " + audience + "]"
            # формируем вывод для преподавателей
            stringTeacher = "Class Pojo [disciplineteacher = " + disciplineteacher + ", countdiscipline = " + countdiscipline + ", countstudent = " + countstudent + ", fullname = " + fullname + "]"
            # выводим на экран результат
            print(stringDiscipline)
            print(stringTeacher)
